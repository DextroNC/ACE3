...
[_this, DFUNC(canTreat), _target, format [QGVAR(canCheckPoison_%1_%2), _selection, _classname], MAX_DURATION_CACHE, QEGVAR(interact_menu,clearConditionCaches)] call EFUNC(common,cachedCall);
